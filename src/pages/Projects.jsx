...
const Projects = () => {
  ...
  return (
    <div className='text-black h-full mb-[100vh] p-2 lg:p-4'>
      <div className='pt-[45vh]'>
        <h2 className='font-[font2] lg:text-[9.5vw] text-7xl uppercase'>Projects</h2>
      </div>
      <div className='-lg:mt-14 chandan'>
        {projects.map(function (elem, idx) {
          return <div key={idx} className='hero w-full lg:h-[500] mb-4 flex lg:flex-row flex-col gap-2 lg:gap-4'>
